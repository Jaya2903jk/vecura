                                                    ...
                                                    tickets.map((t, index) => (
                                                        <tr key={t.ticket_id}>
                                                            ...
                                                            <td className="text-center">
                                                                <span className="badge rounded-pill fw-bold" style={{ background: "#fff3cd", color: "#856404" }}>
                                                                    {t.pending_count}
                                                                </span>
                                                            </td>

                                                            <td className="text-center">
                                                                <span className="badge rounded-pill fw-bold" style={{ background: "#d1ecf1", color: "#0c5460" }}>
                                                                    {t.inprogress_count}
                                                                </span>
                                                            </td>

                                                            <td className="text-center">
                                                                <span className="badge rounded-pill fw-bold" style={{ background: "#d4edda", color: "#155724" }}>
                                                                    {t.closed_count}
                                                                </span>
                                                            </td>
